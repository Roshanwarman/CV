...
#
# # Simulate and plot
# norecordtime = 0.1; # Integration time (seconds) when not recording
#                     # membrane potentials
# recordtime = 0.3; # Integration time for recorded values
...
e.set_mpotential(0,-60)

e.set_mpotential(1,-60)

e.set_Ie(0, 2.5)
e.set_Ie(1,0)

e.make_excitatory_connection(0,1)
e.make_excitatory_connection(1,0)

e.simulate_timeinterval(0.0, 1)

e.plot_membranepotentials([0 ,1 ])
# single1 = nsimulator(1)
# single1.set_mpotential(1, -60)
